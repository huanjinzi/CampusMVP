...
public class StudentFactory {
    ...
    public static Student getStudent(CXParams cxParams) {

        HashMap<String, String> map = null;
        Student student = null;

        if (isLocal(cxParams.getUsename())) {

            return null;
        } else {
            StudentSourceRemote studentSourceRemote = StudentSourceRemote.getInstance();
            try {
                map = studentSourceRemote.getBaseInfoMap(cxParams);
            } catch (Exception e) {
            ...
            if (map != null) {
                ...
                <b>类别*/
                student = new Student();
                student.setNetusername(cxParams.getUsename());
                student.setNetpassword(cxParams.getPassword());
